import { curry, compose, curryN } from '../functional/helpers'
import { isNumber, isArray, isObject, isString, isNil } from './base'
import { isTruthy } from './boolean'
import { split, replace } from './string'
import { filter, reduce } from './array'
...
// @refer to: https://github.com/davidmarkclements/rfdc/blob/master/index
