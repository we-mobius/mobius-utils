...
export const quaternary = fn => curry((x, y, z, a) => fn(x, y, z, a)) // nAry(4, fn)
export const looseQuaternary = fn => looseCurry((x, y, z, a, ...args) => fn(x, y, z, a, ...args)) // looseNAry(4, fn)
export const ternary = fn => curry((x, y, z) => fn(x, y, z)) // nAry(3, fn)
export const looseTernary = fn => looseCurry((x, y, z, ...args) => fn(x, y, z, ...args)) // looseNAry(3, fn)
